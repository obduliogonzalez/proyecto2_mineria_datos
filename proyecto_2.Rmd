...
```{r}
#####Primero, utilizamos el modelo de Random Forest para predecir el estado de ebriedad (ESTADO_EBRIEDAD), basados en variables como sexo, edad, estado civil, mes y área geográfica. Después, se prueba dos escenarios de muestra con valores manuales:
